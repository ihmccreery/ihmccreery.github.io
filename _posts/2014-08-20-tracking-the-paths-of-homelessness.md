...
![The DSSG team who worked with the Chicago Alliance to End Homelessness]({{ site.baseurl }}/media/homelessness/team.png)
...
![The housing inventory in Chicago]({{ site.baseurl }}/media/homelessness/inventory.png)
...
![Point-in-time counts of homelessness in Chicago]({{ site.baseurl }}/media/homelessness/pitcs.png)
...
![Paths to interim housing]({{ site.baseurl }}/media/homelessness/homeless-report1.png)

![Paths from interim housing]({{ site.baseurl }}/media/homelessness/homeless-report2.png)
...
![Do most people end up where they came from?]({{ site.baseurl }}/media/homelessness/stay.png)

Or if they are exiting to different places:

![Or somewhere else?]({{ site.baseurl }}/media/homelessness/cross.png)
...
![Where do people end up after different housing programs?]({{ site.baseurl }}/media/homelessness/sankey.png)
